...
describe('example-tool', () => {
    ...
    it('should process valid input', async () => {
        const result = await client.callTool('example-tool', { input: 'test data' });
    ...
    it('should reject empty input', async () => {
        await expect(client.callTool('example-tool', { input: '' })).rejects.toThrow('Input must not be empty');
    });
    it('should reject missing input', async () => {
        await expect(client.callTool('example-tool', {})).rejects.toThrow('Required');
    });
});
