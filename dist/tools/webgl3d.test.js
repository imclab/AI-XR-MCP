...
describe('webgl-3d-visualization', () => {
    ...
    it('should validate input parameters', async () => {
        // Test empty source
        await expect(client.callTool('webgl-3d-visualization', {
            source: '',
            sourceType: 'website'
    ...
    it('should process website source', async () => {
        ...
        const result = await client.callTool('webgl-3d-visualization', {
            source: 'example.com',
            sourceType: 'website',
            depth: 1,
            layout: 'force',
        ...
        expect(jsonData.nodes.find((n) => n.id === 'root')).toBeDefined();
    });
